...
/// Uniquely identifies a span within the context of a process.
///
/// These identifiers are not guaranteed to be unique across multiple processes,
/// or in a distributed trace. Integrations with distributed tracing systems
/// should use their own representations of trace IDs.
///
